...
% from oscillometric wave and Korotkoff sounds recordings described in:
% "B³X: A Novel Efficient Algorithm for Accurate Automated Auscultatory
% Blood Pressure Estimation"
% 
% The B³X algorithm uses the beat-by-beat cross-correlation (B³X) of
...
% - osc: 1D array that contains the oscillometric wave recording, with
%        values normalized between 0 and 1
% - ks: 1D array that contains the Korotkoff sounds recording, with
%       values normalized between 0 and 1
...
% DBP corresponds to the last point at which B³XD is above the negative
% threshold XTn and B³X is below the positive threshold Tp.  
